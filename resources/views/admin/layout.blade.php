   ...
   <body class="hold-transition sidebar-mini">
      <div class="wrapper">
         ...
         <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <img src="{{ URL::to('adminlte-3.0.5/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
               style="opacity: .8">
            <span class="brand-text font-weight-light">{{ strtoupper(Session::get('user_level')) }}</span>
            </a>
            <!-- Sidebar -->
            <div class="sidebar">
               ...
               <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                  <div class="image">
                     <img src="{{ URL::to('adminlte-3.0.5/dist/img/user2-160x160.jpg') }}" class="img-circle elevation-2" alt="User Image">
                  </div>
                  <div class="info">
                     <a href="" class="d-block">{{ strtoupper(Session::get('user_nama')) }}</a>
                  </div>
               </div>
               <!-- Sidebar Menu -->
               <nav class="mt-2">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ URL::to('/admin/data-pemilik-kos') }}" class="nav-link">
                     ...
                     <li class="nav-item">
                        <a href="{{ URL::to('/admin/data-penyewa-kos') }}" class="nav-link">
                           <i class="nav-icon fas fa-th"></i>
                           <p>
                              Penyewa
                              <!-- <span class="right badge badge-danger">New</span> -->
                    ...
                    <li class="nav-item">
                        <a href="{{ URL::to('/admin/data-rumah-kos') }}" class="nav-link">
                           <i class="nav-icon fas fa-th"></i>
                           <p>
                              Rumah Kos
                              <!-- <span class="right badge badge-danger">New</span> -->
                     ...
                     <li class="nav-header">VALIDASI & MUTASI DANA</li>     
                     <li class="nav-item">
                        <a href="{{ URL::to('/admin/validasi-pembayaran-sewa') }}" class="nav-link">
                           <i class="nav-icon fas fa-th"></i>
                           <p>
                              Validasi Pembayaran
                              <!-- <span class="right badge badge-danger">New</span> -->
                     ...
                     <li class="nav-item">
                        <a href="{{ URL::to('/admin/mutasi-dana') }}" class="nav-link">
                           <i class="nav-icon fas fa-th"></i>
                           <p>
                              Mutasi Dana
                              <!-- <span class="right badge badge-danger">New</span> -->
                     ...
                     <!-- <li class="nav-item">
                       <a href="{{ URL::to('/admin/notifikasi') }}" class="nav-link">
                           <i class="nav-icon fas fa-th"></i>
                           <p>
                              Notifikasi
