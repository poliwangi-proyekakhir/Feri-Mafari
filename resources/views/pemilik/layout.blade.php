            ...
            <div class="sidebar">
               ...
               <nav class="mt-2">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <li class="nav-header">DATA KOS</li> 
                    <li class="nav-item">
                        <a href="{{ URL::to('/pemilik/rumah-kos') }}" class="nav-link">
                     ...
                     <li class="nav-item">
                        <a href="{{ URL::to('/pemilik/tagihan-sewa') }}" class="nav-link">
                           <i class="nav-icon fas fa-th"></i>
                           <p>
                              Tagihan
                              <!-- <span class="right badge badge-danger">New</span> -->
                     ...
                     <li class="nav-item">
                        <a href="{{ URL::to('/pemilik/mutasi-dana') }}" class="nav-link">
                           <i class="nav-icon fas fa-th"></i>
                           <p>
                              Mutasi Dana
                              <!-- <span class="right badge badge-danger">New</span> -->
                     ...
                     <!-- <li class="nav-item">
                       <a href="{{ URL::to('/pemilik/notifikasi') }}" class="nav-link">
                           <i class="nav-icon fas fa-th"></i>
                           <p>
                              Notifikasi                              
                           </p>
                      ...
                      <li class="nav-item">
                       <a href="{{ URL::to('/pemilik/profile') }}" class="nav-link">
                           <i class="nav-icon fas fa-th"></i>
                           <p>
                              Profile
                              <!-- <span class="right badge badge-danger">New</span> -->
