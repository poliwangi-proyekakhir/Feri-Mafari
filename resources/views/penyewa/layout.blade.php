            ...
            <div class="sidebar">
               ...
               <nav class="mt-2">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ URL::to('/penyewa/cari-rumah-kos') }}" class="nav-link">
                     ...
                     <li class="nav-item">
                        <a href="{{ URL::to('/penyewa/tagihan-sewa') }}" class="nav-link">
                           <i class="nav-icon fas fa-th"></i>
                           <p>
                              Tagihan Sewa
                              <!-- <span class="right badge badge-danger">New</span> -->
                     ...
                     <!-- <li class="nav-item">
                       <a href="{{ URL::to('/penyewa/notifikasi') }}" class="nav-link">
                           <i class="nav-icon fas fa-th"></i>
                           <p>
                              Notifikasi                             
                           </p>
                      ...
                      <li class="nav-item">
                       <a href="{{ URL::to('/penyewa/profile') }}" class="nav-link">
                           <i class="nav-icon fas fa-th"></i>
                           <p>
                              Profile
                              <!-- <span class="right badge badge-danger">New</span> -->
